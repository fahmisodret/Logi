...
@section('content')
    <div class="site-section">
        <div class="container">
            ...
            <hr/>
            <h4 class="mb-4">{{$fasilitas->name}}</h4>
            <div class="row">
                <div class="col-md-3">
                    <div class="person">
                        <figure>
                            <a href="{{$fasilitas->image_url}}">
                            <img src="{{$fasilitas->image_url}}" alt="Image" class="img-fluid" onerror="this.src='{{Storage::url('upload/fasilitas/fasilitas.png')}}'">
                            </a>
                        </figure>
