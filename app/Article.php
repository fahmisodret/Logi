...
class Article extends Model
{
    ...
    {
        return $this->belongsToMany('App\Category', 'blog_articles_categories', 'article_id', 'category_id');
    }

    public function tags()
    {
        return $this->belongsToMany('App\Tag', 'blog_articles_tags', 'article_id', 'tag_id');
    }
    ...
    //     $this->attributes['html_content'] = Parsedown::instance()->text($value);
    // }
